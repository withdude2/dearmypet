...
<div>
	<div class="content-wrap">
		...
		<main id="content" class="content" role="main">
			<h1 class="page-title">
				Dynamic - <span class="fw-semi-bold">Tables</span>
			</h1>
			<section class="widget">
					...
					<div class="widget-controls">
						<div class="width-200">
							<div
								...
								</span> <input class="form-control " id="search-countries" type="text"
				...
				<div class="widget-body">
					<p>
						Editable, validatable, filterable and sortable table made with <a
							href="http://backgridjs.com/" target="_blank">Backgrid.js</a>
					</p>
